...
ActiveRecord::Schema.define(version: 20_141_101_173_850) do
  create_table 'categories', force: :cascade do |t|
    t.text     'name',       limit: 65_535, null: false
    t.string   'idsec',      limit: 255
  ...
  create_table 'copied_notes', force: :cascade do |t|
  ...
  create_table 'links', force: :cascade do |t|
    ...
    t.text     'raw_url',     limit: 65_535, null: false
    t.integer  'note_id',     limit: 4
  end
